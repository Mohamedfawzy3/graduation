...
const Visitform = () => {
  return (
    <div className={`${style.visit_info} container py-4 radius-3`}>
      <h3 className="text-center fw-bold">اضافه زياره</h3>
      <form action="" className="col-12 col-sm-10 col-md-10  container ">
            ...
            <div className="">
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  id="description"
                  placeholder="ادخل الجرعه ومواعيد التناول"
                />
              </div>
            </div>
          ...
          <form action="">
            <div>
              ...
              <input
                ...
                type="text"
                id="tahlil"
                placeholder="ادخل التحاليل المطلوبه"
              />
            </div>
            <div className="text-center">
              {" "}
        ...
        <div className="py-3 ">
          <form action="">
            <div>
              <div className="mb-1">
                <label htmlFor="ashea">الاشعه</label>
              </div>
              <input
                className="w-100"
                type="text"
                id="ashea"
                placeholder="ادخل الاشعه المطلوبه"
              />
            </div>
            <button type="submit" className="btn btn-dark btn-sm mt-3">
              اضافه
